...
public class DeployXmlParser
{
     ...
     */
    public DeployXmlParser(String aXmlFileName)
        throws ErpDeploymentException
    {
        xmlFileName = null;
        ...
        oldFileSetPathList = Arrays.asList(DeploymentInit.getSingleton().getFSPaths());
        oldFileSetParPathList = DeploymentInit.getSingleton().getFsParIdLilst();
        File f = new File(xmlFileName);
        outFileName = deployTempDirPath + f.getName().replaceAll("deploy-", "forAnt-");
    }
     ...
     * @throws ErpDeploymentException
     */
    public DeployXmlParser(String aXmlFileName, String aDeployDirPath, String aDeployTempDirPath)
        throws ErpDeploymentException
    {
        xmlFileName = null;
        oldFileSetPathList = null;
