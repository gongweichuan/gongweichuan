 ...
 */
public class SFtpContext implements RuntimeContext, Serializable
{

    public static final String JNDI_NAME = "SftpContext";
    ...
    public SFtpContext(String serverAddress, int serverPort, String userName,
            String userPassword)
    {
    ...
    {
        SFtpContext context = (SFtpContext) o;
