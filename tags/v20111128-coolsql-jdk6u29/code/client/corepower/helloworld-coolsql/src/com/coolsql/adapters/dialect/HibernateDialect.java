...
public interface HibernateDialect {
     ...
     */
    String[] getColumnAddSQL(Column info) 
     ...
     */
    public String getColumnCommentAlterSQL(Column info) throws UnsupportedOperationException; 
     ...
     */
    List<String> getTableDropSQL(Table iTableInfo, boolean cascadeConstraints, boolean isMaterializedView)
     ...
     * @return
     */
    String[] getAddPrimaryKeySQL(String pkName, Column[] colInfos, Table ti);
     ...
     */
    String getColumnNullableAlterSQL(Column info);
     ...
     */
    String getColumnNameAlterSQL(Column from, Column to);
     ...
     */
    List<String> getColumnTypeAlterSQL(Column from, Column to)
        throws UnsupportedOperationException;
     ...
     */
    String getColumnDefaultAlterSQL(Column info);
     ...
     */
    List<String> getCreateTableSQL(List<Table> tables, 
                                   ISQLDatabaseMetaData md,
                                   CreateScriptPreferences prefs,
                                   boolean isJdbcOdbc) throws SQLException,UnifyException;    
