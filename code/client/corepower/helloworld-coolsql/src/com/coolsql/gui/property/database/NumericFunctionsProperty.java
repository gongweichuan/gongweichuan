 ...
 * 2008-6-8 create
 */
public class NumericFunctionsProperty extends BasePropertyPane {

	private static final long serialVersionUID = 1L;
	private static final StringManager stringMgr=StringManagerFactory.getStringManager(NumericFunctionsProperty.class);
	/**
	 * 
	 */
	public NumericFunctionsProperty() {
		super();
	}
	/* (non-Javadoc)
	...
	public void setData(Object ob) {
		...
		if(bookmark.isConnected())  //连接状态，初始化数据类型面板。
        {
        	...
        	try {
				String[] functions=bookmark.getDbInfoProvider().getDatabaseMetaData().getNumericFunctions();
        ...
        }else
        {
        	...
        	panel.add(new JLabel(stringMgr.getString("property.database.numericfunctions.noconnection")));
        }
	}
	/* (non-Javadoc)
