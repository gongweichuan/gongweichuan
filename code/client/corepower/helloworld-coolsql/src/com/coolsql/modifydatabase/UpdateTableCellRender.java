...
/**
 * @author liu_xlin 生成数据库sql的表控件的表格渲染类
 */
public class UpdateTableCellRender extends DefaultTableCellRenderer {
    ...
    /**
     * 
     * @author liu_xlin 自定义边框类,定义了三种未封口的边框,用于更新行数据表控件的选择显示
     */
    protected class ILineBorder extends LineBorder { //___
        public final static int LeftLineBorder = -1; // 左、上、下画上边框

        public final static int DoubleLineBorder = 0; //上、下边框

        public final static int RightLineBorder = 1; //上、下、右边框
