...
import com.coolsql.pub.util.CharSequenceReader;
import com.coolsql.pub.util.SQLLexer;
import com.coolsql.pub.util.StringUtil;
import com.coolsql.sql.formater.SQLToken;
...
public class SqlFormatter
{
	...
	{
		this(aScript, 0, Setting.getInstance().getFormatterMaxSubselectLength());
	}
