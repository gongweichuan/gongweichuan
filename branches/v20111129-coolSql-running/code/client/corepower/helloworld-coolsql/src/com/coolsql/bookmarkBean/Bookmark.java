...
import com.coolsql.view.bookmarkview.model.CatalogNode;
...
import com.coolsql.view.bookmarkview.model.SchemaNode;
...
//    private String autoCommitSet="Always True";
    ...
    {       
        ...
        for(int i=0;i<childCount;i++)
        {
            ...
            if(!(tmp.getUserObject() instanceof SQLGroupNode))  //如果该节点为模式节点，将最近执行sql组合节点除外
        ...
        for(Iterator<Object> it = temp.values().iterator(); it.hasNext();) //删除不存在的分类/模式
        {
