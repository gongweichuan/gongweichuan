...
/**
 * @author liu_xlin 实体基本属性显示面板
 */
public class EntityBaseInfo extends PropertyPane {

	private static final long serialVersionUID = 8554136544302520497L;

	private TextEditor entityName; // 实体名称

	private TextEditor bookmark; // 实体所属书签

	private JLabel catalogLabel;
	private TextEditor catalog;
	private JLabel schemaLabel;
	private TextEditor schema; // 实体模式

	private TextEditor type; // 实体类型（'TABLE','VIEW','SEQUENCE' or else type）
