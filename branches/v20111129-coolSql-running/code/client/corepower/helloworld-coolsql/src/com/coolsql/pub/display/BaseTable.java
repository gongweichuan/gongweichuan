...
import com.coolsql.data.display.action.BaseTableFindAction;
import com.coolsql.data.display.action.DefaultAdjustWidthAction;
...
/**
 * @author liu_xlin 扩展表控件，增加常用的功能。 1、通过在列间双击来调整最佳宽度
 */
public class BaseTable extends JTable {
	...
	private Action preferWidthAction; // 调整最佳宽度的事件处理

	private Action findAction; // 查找单元格信息
