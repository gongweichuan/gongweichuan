 ...
 *
 */
public class AntMainForErp implements AntMain {
    ...
    public static void start(String[] args, Properties additionalUserProperties,
        ...
        AntMainForErp m = new AntMainForErp();
...
//        System.exit(exitCode);
     ...
     */
    protected AntMainForErp(String[] args) throws BuildException {
        processArgs(args);
    }
        ...
        for (int i = 0; i < listeners.size(); i++) {
            ...
            BuildListener listener =
                    (BuildListener) ClasspathUtils.newInstance(className,
                            AntMainForErp.class.getClassLoader(), BuildListener.class);
        ...
        if (loggerClassname != null) {
            try {
                logger = (BuildLogger) ClasspathUtils.newInstance(
                        loggerClassname, AntMainForErp.class.getClassLoader(),
                        BuildLogger.class);
    ...
    public static synchronized String getAntVersion() throws BuildException {
        if (antVersion == null) {
            try {
                Properties props = new Properties();
                InputStream in =
                    AntMainForErp.class.getResourceAsStream("/org/apache/tools/ant/version.txt");
                props.load(in);
                in.close();
