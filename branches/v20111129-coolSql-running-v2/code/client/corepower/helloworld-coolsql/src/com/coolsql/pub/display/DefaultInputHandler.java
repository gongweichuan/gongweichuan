 ...
 * @author Slava Pestov
 * @version $Id: DefaultInputHandler.java,v 1.1 2010/08/03 14:09:18 xiaolin Exp $
 */
	...
	public void keyPressed(KeyEvent evt)
	{
			...
			|| keyCode == KeyEvent.VK_ESCAPE)
		{
			...
			if (keyCode == KeyEvent.VK_TAB)
			{
				...
				if (start < end)
				{
					com.coolsql.pub.display.TextIndenter indenter = new com.coolsql.pub.display.TextIndenter(area);
