...
public class SystemFunctionProperty extends BasePropertyPane{
	...
	public void setData(Object ob) {
		...
		if(bookmark.isConnected())  //连接状态，初始化数据类型面板。
        {
        	...
        	try {
				String[] functions=bookmark.getDbInfoProvider().getDatabaseMetaData().getSystemFunctions();
        ...
        }else
        {
        	...
        	panel.add(new JLabel(stringMgr.getString("property.database.systemfunctions.noconnection")));
        }
	}
	/* (non-Javadoc)
