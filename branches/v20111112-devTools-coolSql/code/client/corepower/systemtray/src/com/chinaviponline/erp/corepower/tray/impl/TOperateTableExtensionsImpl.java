    ...
    */
    ...
    public int countElemntExtensionPoint(Map map)
    {
       ...
       // Integer count=Integer.getInteger("0");        
        Integer tmpO=(Integer)this.getSqlMapClientTemplate().queryForObject(existExtensionPoint, map);
        log.debug("tmpO:"+tmpO);
...
//        Integer countExist=Integer.getInteger("0");
    ...
    public int insertIntoTableExtensions(Map map)
    {
        ...
        Object insertCout=this.getSqlMapClientTemplate().insert(insertIntoExtensions, map);
        log.debug("insertIntoTableExtensions insertCout:"+insertCout);
        return 1;
    }
    ...
    public String getExistTableExtensions()
    {
        return existTableExtensions;
    }

    public void setExistTableExtensions(String existTableExtensions)
    {
        this.existTableExtensions = existTableExtensions;
    }

    public String getCreateTableExtensions()
    {
        return createTableExtensions;
    }

    public void setCreateTableExtensions(String createTableExtensions)
    {
        this.createTableExtensions = createTableExtensions;
    }

    public String getExistExtensionPoint()
    {
        return existExtensionPoint;
    }

    public void setExistExtensionPoint(String existExtensionPoint)
    {
        this.existExtensionPoint = existExtensionPoint;
    }

    public String getDeleteExtensions()
    {
        return deleteExtensions;
    }

    public void setDeleteExtensions(String deleteExtensions)
    {
        this.deleteExtensions = deleteExtensions;
    }

    public String getInsertIntoExtensions()
    {
        return insertIntoExtensions;
    }

    public void setInsertIntoExtensions(String insertIntoExtensions)
    {
        this.insertIntoExtensions = insertIntoExtensions;
    }

    public String getSelectExtensions()
    {
        return selectExtensions;
    }

    public void setSelectExtensions(String selectExtensions)
    {
        this.selectExtensions = selectExtensions;
    }

    public String getUpdateExtensions()
    {
        return updateExtensions;
    }

    public void setUpdateExtensions(String updateExtensions)
    {
