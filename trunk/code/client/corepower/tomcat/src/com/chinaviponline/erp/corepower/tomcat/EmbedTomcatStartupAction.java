...
/**
 * <p>文件名称：EmbedTomcatStartupAction.java</p>
 * <p>文件描述：启动Tomcat</p>
 ...
 */
public class EmbedTomcatStartupAction implements Action
{
    
    private static final String EMBEDDEDTOMCATFRAME = "embeddedTomcatFrame";
    private static final Logger log=Logger.getLogger(EmbedTomcatStartupAction.class);
            ...
            public void run()
            {
                ...
                if(spring!=null)
                {
                    ...
                    if(tomcatFrame!=null && tomcatFrame instanceof EmbeddedTomcatFrame)
                    {
                        ...
                        {
                           log.error("when start tomcat error:"+e.getMessage());                           
                        }
