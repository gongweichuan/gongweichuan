...
//import com.chinaviponline.erp.Erp4Debug.JarFilenameFilter;
//import com.chinaviponline.erp.Erp4Debug.ShutdownHook;
...
/**
 * <p>文件名称：Erp4Debug.java</p>
 * <p>文件描述：测试用、主要测试ClassPath和Spring的集成</p>
 ...
 */
public class Erp4Debug
{
    /**
     * 框架类加载器 classpath
     */
    private static final String JBOSSURLS = "com.chinaviponline.erp.Erp4Debug.jbossurls";
...
//    private static  ApplicationContext ctx=null;
    ...
    public static String ALLSPRINGBEAN="classpath:*-springbean.xml";
    ...
    static
    {
        ...
        try
        {
            ...
            if (logSUBDIR != null || logSUBDIR.equalsIgnoreCase(""))
            {
                ...
                {
                    System.out.println("[Erp4Debug]" + e.toString());
                }
                ...
                System.out.println("[Erp4Debug] log dir: " + logDIR);

                File logfile = new File(logDIR);
                if (!logfile.exists())
                {
                    System.out.println("[Erp4Debug] mkdir " + logDIR);
                    logfile.mkdirs();
                }
                if (!logfile.isDirectory())
                {
                    System.out.println("[Erp4Debug] " + logDIR
        ...
        log = Logger.getLogger(Erp4Debug.class);
...
/*       File springBeanFiles[] = ServiceAccess.getSystemSupportService().getFiles(ALLSPRINGBEAN);
      ...
      /*  ctx=new FileSystemXmlApplicationContext(ALLSPRINGBEAN);
        
        log.debug("Loaded Spring\r\n"+ctx);
        
        log.debug(ctx.getBean("sqlMapClient"));*/
    ...
    private static class ShutdownHook implements Runnable
    {
        ...
        public void run()
        {
            ...
            Erp4Debug.serviceDeployer.undeployServices();
            SystemStateManager.notifySystemState(2);//TODO 替换成常量
            Erp4Debug.log.info("shutdown JVM");
        }
...
//                + propertiesService.get("erp.wholeloginpic.enabled");
        ...
        if (disableText != null && disableText.equals("true"))
        {
            ...
            URL resourceURL = (Erp4Debug.class).getResource(pathBuffer
                    .toString());
            if (resourceURL != null)
            {
