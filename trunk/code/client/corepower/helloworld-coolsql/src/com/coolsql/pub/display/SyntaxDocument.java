	...
	implements UndoableEditListener
{
	...
	private static final org.apache.log4j.Logger logger=org.apache.log4j.Logger.getLogger(SyntaxDocument.class);
	
	
	private UndoManager undoManager = new UndoManager();
	protected TokenMarker tokenMarker;
	private int compoundLevelCounter = 0;
	private CompoundEdit compoundEditItem = null;
	...
	protected void initDefaultProperties()
	{
		...
		this.putProperty(PlainDocument.tabSizeAttribute,new Integer(Setting.getInstance().getEditorTabWidth()));
	}
	/**
	...
	public synchronized void beginCompoundEdit() 
	{
		...
		{
			this.compoundEditItem = new CompoundEdit();
		}
	...
	public synchronized void endCompoundEdit() 
	{
		...
		else if (compoundLevelCounter == 0)
		{
			...
			logger.error("Unbalanced endCompoundEdit()", e);
		}
		else 
		{
			this.compoundLevelCounter --;
