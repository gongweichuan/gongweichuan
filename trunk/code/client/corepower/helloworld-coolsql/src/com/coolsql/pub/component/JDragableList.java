...
/**
 * define a list that can drag all items to other location,switching the
 * location between each other
 * 
 * @author 刘孝林(kenny liu)
 * 
 * 2008-3-26 create
 */
public class JDragableList extends JList
		implements
			DragSourceListener,
			DropTargetListener,
			DragGestureListener {
...
//		System.out.println("dragGestureRecognized");
		...
		if (index == -1)
			return;
		if(dge.getTriggerEvent().getModifiersEx()!=InputEvent.BUTTON1_DOWN_MASK)
			return;
